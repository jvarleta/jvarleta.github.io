...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-josefina.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('capa01.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('capa01.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('capa02.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('capa02.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('capa03.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('capa03.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('capa04.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('capa04.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('capa05.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('capa05.obj', function (group) {
